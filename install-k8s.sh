...
sudo sed -i "/^IP\.2 = .*/a IP\.3 = $SERVER_IP" /var/snap/microk8s/current/certs/csr.conf.template > /var/snap/microk8s/current/certs/csr.conf.template
sudo sed -i "/^DNS\.5 = .*/a DNS\.6 = $SERVER_DNS" /var/snap/microk8s/current/certs/csr.conf.template > /var/snap/microk8s/current/certs/csr.conf.template
